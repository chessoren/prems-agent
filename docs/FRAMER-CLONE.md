# Le pipeline de clonage Framer

> Ce document était le README du dépôt. Il y est resté tant que le dépôt n'était
> qu'un clone du site vitrine. Le produit est désormais l'agent
> (voir [`../README.md`](../README.md)) ; cette page décrit comment la landing
> page et les pages légales sont régénérées depuis Framer, et pourquoi elles ne
> sont pas écrites à la main.
...
[`INTERACTIVE.md`](INTERACTIVE.md), avec la méthode pour le récupérer.
...
Architecture et décisions : [`ONBOARDING.md`](ONBOARDING.md).
Ce qu'il reste à brancher : [`CLOUD-RUN.md`](CLOUD-RUN.md).
...
Architecture, ce qui est branché et ce qui est projeté : [`APP.md`](APP.md).
